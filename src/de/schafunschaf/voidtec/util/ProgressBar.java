...
public class ProgressBar {
    public static ButtonAPI addStorageMeter(TooltipMakerAPI panel, float size, float height, float value,
                                            float maxValue, Color borderColor, Color backgroundColor, Color barColor,
                                            float padding) {
