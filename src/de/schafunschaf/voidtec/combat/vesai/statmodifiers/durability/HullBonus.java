...
public class HullBonus extends BaseStatMod {
    ...
    public HullBonus(String statID, String displayName) {
    ...
    public void applyToShip(MutableShipStatsAPI stats, String id, StatModValue<Float, Float, Boolean, Boolean> statModValue, long randomSeed,
        ...
        if (parentAugment.getInstalledSlot().getSlotCategory() == SlotCategory.FLIGHT_DECK) {
            ...
            stats.getHullBonus().modifyMult(id, 1f + generateModValue(statModValue, randomSeed, parentAugment.getAugmentQuality()) / 100f);
        }
    }
    ...
    public void generateTooltipEntry(MutableShipStatsAPI stats, String id, TooltipMakerAPI tooltip, Color bulletColor,
                                     AugmentApplier parentAugment) {
        MutableStat.StatMod statMod = stats.getHullBonus().getMultBonus(id);

        String description = "Base hull strength %s by %s";
    ...
    public LabelAPI generateStatDescription(TooltipMakerAPI tooltip, Color bulletColor, float minValue, float maxValue) {
        ...
        String hlString = "base hull strength";
    ...
    public void applyToFighter(MutableShipStatsAPI stats, String id, float value) {
        stats.getHullBonus().modifyMult(id, value);
    }
}
