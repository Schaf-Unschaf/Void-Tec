...
public class BallisticDamage extends BaseStatMod {
    ...
    public BallisticDamage(String statID, String displayName) {
    ...
    public void generateTooltipEntry(MutableShipStatsAPI stats, String id, TooltipMakerAPI tooltip, Color bulletColor,
                                     AugmentApplier parentAugment) {
        MutableStat.StatMod statMod = stats.getBallisticWeaponDamageMult().getMultStatMod(id);
    ...
    public void applyToFighter(MutableShipStatsAPI stats, String id, float value) {
        stats.getBallisticWeaponDamageMult().modifyMult(id, value);
    }
}
