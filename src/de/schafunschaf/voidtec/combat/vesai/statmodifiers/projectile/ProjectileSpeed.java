...
public class ProjectileSpeed extends BaseStatMod {

    public ProjectileSpeed(String statID) {
        super(statID);
    }
    ...
    public void applyToShip(MutableShipStatsAPI stats, String id, StatModValue<Float, Float, Boolean> statModValue, Random random,
        ...
        if (parentAugment.getInstalledSlot().getSlotCategory() == SlotCategory.FLIGHT_DECK) {
            ...
            stats.getBallisticProjectileSpeedMult()
    ...
    public void generateTooltipEntry(MutableShipStatsAPI stats, String id, TooltipMakerAPI tooltip, Color bulletColor,
                                     AugmentApplier parentAugment) {
        MutableStat.StatMod statMod = stats.getBallisticProjectileSpeedMult().getPercentStatMod(id);
    ...
    public void generateStatDescription(TooltipMakerAPI tooltip, Color bulletColor, float minValue, float maxValue) {
        ...
        String hlString = "speed of projectiles";
        String description = String.format("the %s fired from weapons", hlString);
    ...
    public void applyToFighter(MutableShipStatsAPI stats, String id, float value) {
        stats.getProjectileSpeedMult().modifyPercent(id, value);
    }
}
