...
public class FluxCapacity extends BaseStatMod {
    ...
    public void applyToShip(MutableShipStatsAPI stats, String id, StatModValue<Float, Float, Boolean> statModValue, Random random,
        ...
        if (parentAugment.getInstalledSlot().getSlotCategory() == SlotCategory.FLIGHT_DECK) {
            ...
            stats.getFluxCapacity().modifyPercent(id, generateModValue(statModValue, random, parentAugment.getAugmentQuality()));
        }
    }
    ...
    public void applyToFighter(MutableShipStatsAPI stats, String id, float value) {
        stats.getFluxCapacity().modifyPercent(id, value);
    }
}
