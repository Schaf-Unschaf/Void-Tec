...
public class ZeroFluxLimit extends BaseStatMod {
    ...
    public ZeroFluxLimit(String statID) {
        super(statID);
    }
    ...
    public void applyToShip(MutableShipStatsAPI stats, String id, StatModValue<Float, Float, Boolean> statModValue, Random random,
        ...
        if (parentAugment.getInstalledSlot().getSlotCategory() == SlotCategory.FLIGHT_DECK) {
            ...
            stats.getZeroFluxMinimumFluxLevel().modifyFlat(id, generateModValue(statModValue, random, parentAugment.getAugmentQuality()));
        }
    }
