...
public enum SlotCategory {
    UNIVERSAL("Universal", new Color(200, 200, 200), 1, UNIVERSAL_SLOT_ICON), WEAPON("Weapon", new Color(200, 0, 0), 4, WEAPON_SLOT_ICON), STRUCTURE("Structure", new Color(0, 200, 0), 4, STRUCTURE_SLOT_ICON), SHIELD("Shield", new Color(0, 200, 255), 4, SHIELD_SLOT_ICON), REACTOR("Reactor", new Color(170, 70, 225), 3, REACTOR_SLOT_ICON), ENGINE("Engine", new Color(255, 100, 0), 3, ENGINE_SLOT_ICON), LOGISTIC("Logistic", new Color(200, 200, 0), 1, LOGISTIC_SLOT_ICON), SPECIAL("Special", new Color(0, 200, 150), 0, SPECIAL_SLOT_ICON);
