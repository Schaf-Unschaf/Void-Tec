...
public class ArmorBonus extends BaseStatMod {
    public ArmorBonus(float baseValue) {
        super(baseValue);
    ...
    public void apply(MutableShipStatsAPI stats, String id, Random random, UpgradeQuality quality) {
        ...
        stats.getArmorBonus().modifyPercent(id, 1f + generateModValue(random, quality), quality.getName());
    }
    ...
    public void generateTooltipEntry(MutableShipStatsAPI stats, String id, TooltipMakerAPI tooltip) {
        ...
        String description = "Armor strength %s by %s";
