...
public class EngineRepair extends BaseStatMod {
    public EngineRepair(float baseValue) {
        super(baseValue);
    ...
    public void apply(MutableShipStatsAPI stats, String id, Random random, UpgradeQuality quality) {
        ...
        stats.getCombatEngineRepairTimeMult().modifyPercent(id, 1f - generateModValue(random, quality), quality.getName());
    }
    ...
    public void generateTooltipEntry(MutableShipStatsAPI stats, String id, TooltipMakerAPI tooltip) {
        ...
        String description = "Weapon repair time %s by %s";
