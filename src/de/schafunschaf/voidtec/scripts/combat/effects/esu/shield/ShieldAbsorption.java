package de.schafunschaf.voidtec.scripts.combat.effects.esu.shield;
...
@Getter
public class ShieldAbsorption extends BaseStatMod {
    public ShieldAbsorption(float baseValue) {
        super(baseValue);
    }

    @Override
    public void apply(MutableShipStatsAPI stats, String id, Random random, UpgradeQuality quality) {
        stats.getShieldAbsorptionMult().modifyFlat(id, -generateModValue(random, ));
    }
