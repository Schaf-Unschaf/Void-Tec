...
public class ShipAcceleration extends BaseStatMod {
    ...
    public void apply(MutableShipStatsAPI stats, String id, StatModValue<Float, Float, Boolean> statModValue, Random random, UpgradeQuality quality) {
        stats.getAcceleration().modifyPercent(id, 1f + generateModValue(statModValue, random, quality));
        stats.getDeceleration().modifyPercent(id, 1f + generateModValue(statModValue, random, quality));
    }
