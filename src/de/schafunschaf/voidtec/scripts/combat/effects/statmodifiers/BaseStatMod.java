...
public abstract class BaseStatMod implements StatApplier {
    protected float generateModValue(StatModValue<Float, Float, Boolean> statModValue, Random random,
    ...
    protected void generateTooltip(TooltipMakerAPI tooltip, MutableStat.StatMod statMod, String description,
        ...
        tooltip.addPara("%s " + description, 0f, new Color[]{bulletColor, hlColor,
                                                             hlColor}, bullet, incDec, Math.abs(value) + "%");
    }

    protected void generateStatDescription(TooltipMakerAPI tooltip, String description, String incDecText,
                                           Color bulletColor, boolean isPositive, String... highlights) {
        String bullet = "•";
